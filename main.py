...
# --- Registration Logic (FIXED: CSV handling and sample count) ---
def UploadAndRegister():
    ...
    if file_path:
        ...
        # FIXED: Checking and creating CSV with correct headers to avoid KeyError
        ...
        for (x, y, w, h) in faces:
            # 30 samples taaki recognition improve ho
            for i in range(1, 31):
...
# --- Scanner Logic (FIXED: Improved Recognition) ---
def TrackImages():
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            # conf < 75 standard hai LBPH ke liye
            if conf < 75: 
